# AWS EBS CSI Driver Add-on for EKS
# This addon enables dynamic provisioning of EBS volumes in EKS

locals {
  oidc_provider_arn = module.eks.oidc_provider_arn
  # Extract OIDC provider URL from ARN (format: arn:aws:iam::ACCOUNT:oidc-provider/oidc.eks.REGION.amazonaws.com/id/ID)
  oidc_provider_url = replace(local.oidc_provider_arn, "/^arn:aws:iam::[0-9]+:oidc-provider/", "")
}
